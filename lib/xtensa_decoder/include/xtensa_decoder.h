...
constexpr uint32_t XTENSA_PRESET_ESP8266 = XTENSA_OPT_CODE_DENSITY | XTENSA_OPT_MUL32 | XTENSA_OPT_MUL16
	| XTENSA_OPT_MISC | XTENSA_OPT_EXCEPTION2 | XTENSA_OPT_DEBUG;


constexpr uint32_t XTENSA_PRESET_ESP32 = XTENSA_OPT_CODE_DENSITY | XTENSA_OPT_LOOP | XTENSA_OPT_BOOLEAN
	| XTENSA_OPT_WINDOWED | XTENSA_OPT_MUL32 | XTENSA_OPT_MUL16 | XTENSA_OPT_DIV32 | XTENSA_OPT_MAC16 | XTENSA_OPT_FP
	| XTENSA_OPT_COND_STORE | XTENSA_OPT_MISC | XTENSA_OPT_EXCEPTION2 | XTENSA_OPT_DEBUG;
...
static inline bool xtensa_is_call(XtensaInsnId id)
{
	return (id >= XTENSA_INS_CALL0 && id <= XTENSA_INS_CALLX12);
}


static inline bool xtensa_is_return(XtensaInsnId id)
{
	return (id == XTENSA_INS_RET || id == XTENSA_INS_RETW || id == XTENSA_INS_RET_N || id == XTENSA_INS_RETW_N);
}


static inline bool xtensa_is_branch(XtensaInsnId id)
{
	return (id == XTENSA_INS_J || id == XTENSA_INS_JX || id == XTENSA_INS_BF || id == XTENSA_INS_BT
		|| (id >= XTENSA_INS_BEQ && id <= XTENSA_INS_BGEUI) || id == XTENSA_INS_BEQZ_N || id == XTENSA_INS_BNEZ_N);
}


static inline bool xtensa_is_conditional(XtensaInsnId id)
{
	return (id == XTENSA_INS_BF || id == XTENSA_INS_BT || (id >= XTENSA_INS_BEQ && id <= XTENSA_INS_BGEUI)
		|| id == XTENSA_INS_BEQZ_N || id == XTENSA_INS_BNEZ_N);
}
