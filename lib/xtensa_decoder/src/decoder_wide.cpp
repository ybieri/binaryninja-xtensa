...
static inline
uint32_t read_insn_bytes(const uint8_t *data, int length)
{
    uint32_t insn = 0;
...
int decode_wide(const uint8_t *data, uint64_t addr, XtensaInstruction *insn, uint32_t options)
{
    ...
    switch (op0)
    {
        case 0x00: return _wide_op0_00(raw, addr, insn, options);
        case 0x01: return _wide_op0_01(raw, addr, insn, options);
        case 0x02: return _wide_op0_02(raw, addr, insn, options);
        case 0x03: return _wide_op0_03(raw, addr, insn, options);
        case 0x04: return _wide_op0_04(raw, addr, insn, options);
        case 0x05: return _wide_op0_05(raw, addr, insn, options);
        case 0x06: return _wide_op0_06(raw, addr, insn, options);
        case 0x07: return _wide_op0_07(raw, addr, insn, options);
        default: break;
    }
