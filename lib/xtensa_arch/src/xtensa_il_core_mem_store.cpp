    ...
    switch (insn.id)
    {
        case XTENSA_INS_S8I:
        {
            ...
            il.AddInstruction(il.Store(1,
                ...
                il.LowPart(1, il.Register(4, src))
            ));
        ...
        case XTENSA_INS_S16I:
        {
            ...
            il.AddInstruction(il.Store(2,
                ...
                il.LowPart(2, il.Register(4, src))
            ));
        ...
        case XTENSA_INS_SSI:
        {
            ...
            {
                LogWarn("SSI instruction at 0x%" PRIx64 " has unexpected operand types (expected FPREG, got %d)", addr, insn.operands[0].type);
                il.AddInstruction(il.Undefined());
                return true;
            }
