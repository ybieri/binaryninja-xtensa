    ...
    switch (insn.id)
    {
        ...
        case XTENSA_INS_ADD_S:
        {
            if (insn.operand_count != 3 ||
                insn.operands[0].type != XTENSA_OP_FPREG ||
                insn.operands[1].type != XTENSA_OP_FPREG ||
                insn.operands[2].type != XTENSA_OP_FPREG)
            {
        ...
        case XTENSA_INS_ABS_S:
        {
            ...
            il.AddInstruction(il.SetRegister(4, dest,
                il.FloatAbs(4, il.Register(4, src))
            ));
            return true;
        }
        ...
        case XTENSA_INS_NEG_S:
        {
            ...
            il.AddInstruction(il.SetRegister(4, dest,
                il.FloatNeg(4, il.Register(4, src))
            ));
            return true;
        }

        //=====================================================================
        // FP Load/Store Immediate (base + scaled offset)
        //=====================================================================
        ...
        case XTENSA_INS_LSIU:
        {
            ...
            il.AddInstruction(il.SetRegister(4, base,
                il.Add(4,
                    il.Register(4, base),
                    il.Const(4, offset)
                )
        ...
        //=====================================================================
        // FP Load/Store Indexed (base + index register)
        //=====================================================================
        ...
        //=====================================================================
        // FP Multiply-Add/Subtract (Unimplemented - complex semantics)
        //=====================================================================
        ...
        //=====================================================================
        // FP Register Transfer (Unimplemented)
        //=====================================================================
        case XTENSA_INS_RFR:
        case XTENSA_INS_WFR:
        ...
        //=====================================================================
        // FP Compare - Results stored in boolean register (flag)
        // Format: OP.S br, fs, ft
        // where br = boolean register (b0-b15), fs/ft = FP registers
        //=====================================================================
        ...
        //=====================================================================
        // FP Conditional Move (Unimplemented)
        //=====================================================================
        ...
        //=====================================================================
        // FP Helper Instructions (Unimplemented - divide/sqrt sequences)
        //=====================================================================
