...
LLIL_LIFTER(core_branch)
{
	...
	case XTENSA_INS_BANY:
	{
		...
		il.AddInstruction(il.If(il.CompareNotEqual(4, il.And(4, il.Register(4, s), il.Register(4, t)), il.Const(4, 0)),
			trueLabel, falseLabel));
	...
	case XTENSA_INS_BNONE:
	{
		...
		il.AddInstruction(il.If(il.CompareEqual(4, il.And(4, il.Register(4, s), il.Register(4, t)), il.Const(4, 0)),
			trueLabel, falseLabel));
	...
	case XTENSA_INS_BALL:
	{
		...
		il.AddInstruction(il.If(il.CompareEqual(4, il.And(4, il.Register(4, s), il.Register(4, t)), il.Register(4, t)),
			trueLabel, falseLabel));
	...
	case XTENSA_INS_BNALL:
	{
		...
		// Branch if (AR[s] & AR[t]) != AR[t]
		il.AddInstruction(il.If(
			il.CompareNotEqual(4, il.And(4, il.Register(4, s), il.Register(4, t)), il.Register(4, t)), trueLabel,
			falseLabel));
	...
	case XTENSA_INS_BBC:
	{
		...
		il.AddInstruction(il.If(
			il.CompareEqual(4,
				il.And(4, il.LogicalShiftRight(4, il.Register(4, s), il.And(4, il.Register(4, t), il.Const(4, 0x1F))),
					il.Const(4, 1)),
				il.Const(4, 0)),
			trueLabel, falseLabel));
