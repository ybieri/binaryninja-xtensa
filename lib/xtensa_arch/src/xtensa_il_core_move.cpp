    ...
    switch (insn.id)
    {
        ...
        case XTENSA_INS_MOVEQZ:
        {
            ...
            il.AddInstruction(il.If(
                il.CompareEqual(4, il.Register(4, cond), il.Const(4, 0)),
                trueLabel,
                falseLabel
            ));
        ...
        case XTENSA_INS_MOVNEZ:
        {
            ...
            il.AddInstruction(il.If(
                il.CompareNotEqual(4, il.Register(4, cond), il.Const(4, 0)),
                trueLabel,
                falseLabel
            ));
        ...
        case XTENSA_INS_MOVLTZ:
        {
            ...
            il.AddInstruction(il.If(
                il.CompareSignedLessThan(4, il.Register(4, cond), il.Const(4, 0)),
                trueLabel,
                falseLabel
            ));
        ...
        case XTENSA_INS_MOVGEZ:
        {
            ...
            il.AddInstruction(il.If(
                il.CompareSignedGreaterEqual(4, il.Register(4, cond), il.Const(4, 0)),
                trueLabel,
                falseLabel
            ));
