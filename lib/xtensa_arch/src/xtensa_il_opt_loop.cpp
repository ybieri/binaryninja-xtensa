...
LLIL_LIFTER(opt_loop)
{
    switch (insn.id)
    {
        case XTENSA_INS_LOOP:
        {
            ...
            // LCOUNT = AR[s] - 1
            il.AddInstruction(il.SetRegister(4, REG_LCOUNT,
                il.Sub(4, il.Register(4, count_reg), il.Const(4, 1))));
        ...
        case XTENSA_INS_LOOPGTZ:
        {
            ...
            il.AddInstruction(il.If(
                il.CompareSignedGreaterThan(4, il.Register(4, count_reg), il.Const(4, 0)),
                loopLabel,
                skipLabel
            ));
        ...
        case XTENSA_INS_LOOPNEZ:
        {
            ...
            // if (AR[s] != 0) goto loopLabel else goto skipLabel
            il.AddInstruction(il.If(
                il.CompareNotEqual(4, il.Register(4, count_reg), il.Const(4, 0)),
                loopLabel,
                skipLabel
            ));
