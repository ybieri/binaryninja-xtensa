...
LLIL_LIFTER(opt_misc)
{
    ...
    case XTENSA_INS_MAX:
    {
        ...
        // if (AR[s] > AR[t]) goto trueLabel else goto falseLabel
        il.AddInstruction(
            il.If(il.CompareSignedGreaterThan(4, il.Register(4, s), il.Register(4, t)), trueLabel, falseLabel));
    ...
    case XTENSA_INS_MAXU:
    {
        ...
        // if (AR[s] >u AR[t]) goto trueLabel else goto falseLabel
        il.AddInstruction(
            il.If(il.CompareUnsignedGreaterThan(4, il.Register(4, s), il.Register(4, t)), trueLabel, falseLabel));
    ...
    case XTENSA_INS_SEXT:
    {
        ...
        else
        {
            ...
            il.AddInstruction(il.SetRegister(4, dest,
                il.ArithShiftRight(
                    4, il.ShiftLeft(4, il.Register(4, src), il.Const(4, shift_amount)), il.Const(4, shift_amount))));
        }
