...
LLIL_LIFTER(core_pc)
{
    switch (insn.id)
    {
        ...
        case XTENSA_INS_WSR:
        {
            ...
            il.AddInstruction(
                il.Intrinsic(
                    {},
                    ARCH_INTRINSIC_WSR,
                    {il.Const(4, sr), il.Register(4, at)}
                )
            );
            return true;
        }
        ...
        case XTENSA_INS_ISYNC:
        {
            ...
            il.AddInstruction(
                il.Intrinsic({}, ARCH_INTRINSIC_ISYNC, {})
            );
            return true;
        }
        ...
        case XTENSA_INS_RSYNC:
        {
            ...
            il.AddInstruction(
                il.Intrinsic({}, ARCH_INTRINSIC_RSYNC, {})
            );
            return true;
        }
        ...
        case XTENSA_INS_ESYNC:
        {
            ...
            il.AddInstruction(
                il.Intrinsic({}, ARCH_INTRINSIC_ESYNC, {})
            );
            return true;
        }
        ...
        case XTENSA_INS_DSYNC:
        {
            ...
            il.AddInstruction(
                il.Intrinsic({}, ARCH_INTRINSIC_DSYNC, {})
            );
            return true;
        }
