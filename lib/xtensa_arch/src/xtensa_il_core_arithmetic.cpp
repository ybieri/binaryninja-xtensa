...
LLIL_LIFTER(core_arithmetic)
{
	...
	case XTENSA_INS_ADDX2:
	{
		...
		il.AddInstruction(il.SetRegister(
			4, dest, il.Add(4, il.ShiftLeft(4, il.Register(4, src1), il.Const(4, 1)), il.Register(4, src2))));
	...
	case XTENSA_INS_ADDX4:
	{
		...
		// AR[r] = (AR[s] << 2) + AR[t]
		il.AddInstruction(il.SetRegister(
			4, dest, il.Add(4, il.ShiftLeft(4, il.Register(4, src1), il.Const(4, 2)), il.Register(4, src2))));
	...
	case XTENSA_INS_ADDX8:
	{
		...
		// AR[r] = (AR[s] << 3) + AR[t]
		il.AddInstruction(il.SetRegister(
			4, dest, il.Add(4, il.ShiftLeft(4, il.Register(4, src1), il.Const(4, 3)), il.Register(4, src2))));
	...
	case XTENSA_INS_SUB:
	{
		...
		il.AddInstruction(il.SetRegister(4, dest, il.Sub(4, il.Register(4, src1), il.Register(4, src2))));
	...
	case XTENSA_INS_SUBX2:
	{
		...
		// AR[r] = (AR[s] << 1) - AR[t]
		il.AddInstruction(il.SetRegister(
			4, dest, il.Sub(4, il.ShiftLeft(4, il.Register(4, src1), il.Const(4, 1)), il.Register(4, src2))));
	...
	case XTENSA_INS_SUBX4:
	{
		...
		// AR[r] = (AR[s] << 2) - AR[t]
		il.AddInstruction(il.SetRegister(
			4, dest, il.Sub(4, il.ShiftLeft(4, il.Register(4, src1), il.Const(4, 2)), il.Register(4, src2))));
	...
	case XTENSA_INS_SUBX8:
	{
		...
		// AR[r] = (AR[s] << 3) - AR[t]
		il.AddInstruction(il.SetRegister(
			4, dest, il.Sub(4, il.ShiftLeft(4, il.Register(4, src1), il.Const(4, 3)), il.Register(4, src2))));
